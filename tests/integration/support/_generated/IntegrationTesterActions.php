<?php  //[STAMP] f543d1c6dce36b30bd76fbce2528d6cb
namespace Tests\Integration\_generated;
...
trait IntegrationTesterActions
{
     ...
     */
    public function runSymfonyConsoleCommand($command, $params = null) {
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Attaches a file relative to the Codeception `codecept._data` directory to the given file upload field.
     *
     * ``` php
     * <?php
     * // file is stored in 'tests/codecept._data/prices.xls'
     ...
     * // saved to: tests/codecept._output/debug/edit_page.html
     * $I->makeHtmlSnapshot();
     * // saved to: tests/codecept._output/debug/2017-05-26_14-24-11_4b3403665fea6.html
     * ```
     *
     * @param null $name
